...
-- AlterTable
ALTER TABLE "Component" ADD COLUMN     "organizationId" TEXT;

-- AlterTable
ALTER TABLE "Gap" ADD COLUMN     "organizationId" TEXT;

-- AlterTable
ALTER TABLE "Project" ADD COLUMN     "organizationId" TEXT;

-- AlterTable
ALTER TABLE "Relationship" ADD COLUMN     "organizationId" TEXT;
